 ...
 * all platforms.  Additionally, the Windows OpenGL include needs APIENTRY.
 */
#ifndef APIENTRY
 #ifdef _WIN32
 ...
 * the OS X OpenGL include blocks the definition of ptrdiff_t by glext.h.
 ...
 */
  ...
  * configuration include when compiling the DLL version of the library.
  */
