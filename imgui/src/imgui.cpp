...
/*
 ...
 HOW A SIMPLE RENDERING FUNCTION MAY LOOK LIKE:
    ...
    void void MyImGuiRenderFunction(ImDrawData* draw_data)
    {
       ...
       // TODO: Setup shaders: vertex { float2 pos, float2 uv, u32 color }, fragment shaders sample color from 1 texture, multiply by vertex color.
...
#pragma clang diagnostic ignored "-Wzero-as-null-pointer-constant"  // warning : zero as null pointer constant              // some standard include variations use #define NULL 0
#endif
